...
class Map {
  Map (widget w1, widget w2, widget w3, widget w4, widget w5, widget w6, widget w7, widget w8,
  widget w9, widget w10, widget w11, widget w12, widget w13, widget w14, widget w15, widget w16,widget w17, widget w18, 
  widget w19, widget w20, widget w21, widget w22, widget w23, widget w24,widget w25, widget w26, widget w27, widget w28,
  widget w29, widget w30, widget w31, widget w32, widget w33, widget w34, widget w35, widget w36, widget w37, 
  widget w38, widget w39, widget w40, widget w41, widget w42, widget w43, widget w44, widget w45, widget w46, 
  widget w47, widget w48, widget w49, widget w50, widget w51) {
    michiganWidget = w1;
    ohioWidget = w2;
    alabamaWidget = w3; 
    alaskaWidget = w4;
    ...
    californiaWidget= w7;
    coloradoWidget = w8;
    connecticutWidget = w9;
    delawareWidget = w10; 
    districtofColumbiaWidget = w11;
    floridaWidget = w12;
    georgiaWidget = w13;
    hawaiiWidget = w14;
    idahoWidget = w15;
    ...
    maineWidget = w22;
    marylandWidget = w23;
    massachusettsWidget = w24;
    minnesotaWidget = w25;
    mississippiWidget = w26;
    missouriWidget = w27;
    montanaWidget = w28;
    nebraskaWidget = w29;
    nevadaWidget =w30;
    newHampshireWidget = w31;
    newJerseyWidget = w32;
    newMexicoWidget = w33;
    newYorkWidget = w34;
    northCarolinaWidget = w35;
    northDakotaWidget = w36;
    oklahomaWidget = w37;
    oregonWidget = w38;
    pennsylvaniaWidget = w39;
    rhodeIslandWidget = w40;
    southCarolinaWidget = w41;
    southDakotaWidget = w42;
    tennesseeWidget = w43;
    texasWidget = w44;
    utahWidget = w45;
    vermontWidget = w46;
    virginiaWidget = w47;
    washingtonWidget = w48;
    westVirginiaWidget = w49;
    wisconsinWidget = w50;
    wyomingWidget = w51;
  }
  void draw() {
